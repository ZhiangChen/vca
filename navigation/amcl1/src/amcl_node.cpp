...
static const std::string scan_topic_ = "robot1/scan";
        ...
        first_reconfigure_call_(true)
{
  ...
  pose_pub_ = nh_.advertise<geometry_msgs::PoseWithCovarianceStamped>("robot1/amcl_pose", 2, true);
  particlecloud_pub_ = nh_.advertise<geometry_msgs::PoseArray>("robot1/particlecloud", 2, true);

  particlecloud_weighted_pub_ = nh_.advertise<collvoid_msgs::PoseArrayWeighted>("robot1/particlecloud_weighted", 2, true);
  ...
  laser_scan_filter_->registerCallback(boost::bind(&AmclNode::laserReceived,
                                                   this, _1));
  initial_pose_sub_ = nh_.subscribe("robot1/initialpose", 2, &AmclNode::initialPoseReceived, this);
